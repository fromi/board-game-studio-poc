...
import {FORCE_FIELD} from '../material/HuntCards'
...
function placeCanBePlayed(game, place) {
  return !(game.creature.huntCardsPlayed.includes(FORCE_FIELD) && game.huntTokensLocations[TARGET_TOKEN].includes(place))
}