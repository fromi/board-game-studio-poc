...
export const placeRule = place => {
  switch (place) {
    case THE_LAIR: return Lair
    case THE_JUNGLE: return Jungle
    case THE_RIVER: return River
    case THE_BEACH: return Beach
    case THE_ROVER: return Rover
    case THE_SWAMP: return Swamp
    case THE_SHELTER: return Shelter
    case THE_WRECK: return Wreck
    case THE_SOURCE: return Source
    case THE_ARTEFACT: return Artefact
  }
}
